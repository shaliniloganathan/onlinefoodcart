...
btn.forEach((button)=>{
    button.addEventListener('click',()=>{
      if( button.classList.contains('btn-left')){
        ...
        contain.style.background =`  url("../../../assets/images/img1.jpg") cover no-repeat`
        contain.style.background =`  url("../../../assets/images/img2.jpg") cover no-repeat`
      ...
      contain.style.background =`  url("../../../assets/images/img1.jpg")center no-repeat`
      contain.style.background =`  url("../../../assets/images/img2.jpg") cover no-repeat`
